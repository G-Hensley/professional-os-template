...
│  │  ┌────┐                     │  │                                     │   │
│  │  │ YN │  Your Name          │  │  Active Projects    3               │   │
│  │  └────┘  Software Engineer  │  │  Planned Projects   5               │   │
│  │          Current Company    │  │  Job Applications   12              │   │
│  │                             │  │  LinkedIn Drafts    4               │   │
│  └─────────────────────────────┘  └─────────────────────────────────────┘   │
│                                                                             │
│  ┌───────────────────────────────────────────────────────────────────────┐  │
...
│  │                                                                     │    │
│  │  ┌────────────────────────────────────────────────────────────┐     │    │
│  │  │  🔗 github.com/yourusername/professional-os                │     │    │
...
│  │  ACCOUNT                                                            │    │
│  │                                                                     │    │
│  │  Signed in as: you@example.com (via GitHub)                         │    │
│  │                                                                     │    │
...
│  │  YOUR REPOSITORIES                                                  │    │
│  │                                                                     │    │
│  │  ○ yourusername/professional-os         ✓ Valid structure           │    │
│  │  ○ yourusername/my-career-data          ✓ Valid structure           │    │
│  │  ○ yourusername/dotfiles                ✗ Not Professional OS       │    │
│  │                                                                     │    │
│  └─────────────────────────────────────────────────────────────────────┘    │
│                                                                             │
